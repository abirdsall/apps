...
//            
//            fShader = fShader + "\
//            fs_" + i + " = textureLod( texture0, fragment_tcoord, lod ) * weight[ 0 ];\n\
//            for( int i = 1; i < 5; i++ )\n\
//            {\n\
//            fs_layer += textureLod( texture0, ( vec3( fragment_tcoord.x, fragment_tcoord.y, " + tz + ") + vec3( " + lookup + " ) ), lod ) * weight[ i ];\n\
//            fs_layer += textureLod( texture0, ( vec3( fragment_tcoord.x, fragment_tcoord.y, " + tz + ") - vec3( " + lookup + " ) ), lod ) * weight[ i ];\n\
//            }\n";
//        }
//        
