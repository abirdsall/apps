...
bool intersect(const line& line, const geometry::triangle& triangle, v3* outPosition, v3* outNormal, const f32 lineLength = MaxF32);
bool intersect(const line& line, const aabb& aabb, const f32 lineLength = MaxF32);
