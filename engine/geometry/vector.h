...
extern const v3 kXAxis;
extern const v3 kYAxis;
extern const v3 kZAxis;
extern const v3 kV3Zero;
extern const v3 kV3One;
...
inline f32	length(const v2& a)								{return math::sqrt(dot(a, a));}
inline f32	length(const v3& a)								{return math::sqrt(dot(a, a));}
inline f32	length(const v4& a)								{return math::sqrt(dot(a, a));}
...
inline v2	abs(const v2& a)								{return v2(math::abs(a.x), math::abs(a.y));}
inline v3	abs(const v3& a)								{return v3(math::abs(a.x), math::abs(a.y), math::abs(a.z));}
inline v4	abs(const v4& a)								{return v4(math::abs(a.x), math::abs(a.y), math::abs(a.z), math::abs(a.w));}
inline v2	min(const v2& a, const v2& b)					{return v2(math::min(a.x, b.x), math::min(a.y, b.y));}
inline v3	min(const v3& a, const v3& b)					{return v3(math::min(a.x, b.x), math::min(a.y, b.y), math::min(a.z, b.z));}
inline v4	min(const v4& a, const v4& b)					{return v4(math::min(a.x, b.x), math::min(a.y, b.y), math::min(a.z, b.z), math::min(a.w, b.w));}
inline v2	max(const v2& a, const v2& b)					{return v2(math::max(a.x, b.x), math::max(a.y, b.y));}
inline v3	max(const v3& a, const v3& b)					{return v3(math::max(a.x, b.x), math::max(a.y, b.y), math::max(a.z, b.z));}
inline v4	max(const v4& a, const v4& b)					{return v4(math::max(a.x, b.x), math::max(a.y, b.y), math::max(a.z, b.z), math::max(a.w, b.w));}
inline v2	clamp(const v2& a, const v2& b, const v2& c)	{return v2(math::clamp(a.x, b.x, c.x), math::clamp(a.y, b.y, c.y));}
inline v3	clamp(const v3& a, const v3& b, const v3& c)	{return v3(math::clamp(a.x, b.x, c.x), math::clamp(a.y, b.y, c.y), math::clamp(a.z, b.z, c.z));}
...
inline v2	normaliseFast(const v2& a)						{return a * math::rsqrt(dot(a, a));}
inline v3	normaliseFast(const v3& a)						{return a * math::rsqrt(dot(a, a));}
inline v4	normaliseFast(const v4& a)						{return a * math::rsqrt(dot(a, a));}
...
{
    f32	sa = math::sintable(c * 0.5f);
    f32	ca = math::costable(c * 0.5f);
...
{
    return (math::abs(a.x) < math::abs(a.y) ? (math::abs(a.x) < math::abs(a.z) ? 0 : 2) : (math::abs(a.y) < math::abs(a.z) ? 1 : 2));
}
...
{
    f32 p = math::randomfraction() * kPiMul2;
    f32 z = math::randomrange(-1.0f, 1.0f);
    f32 r = math::sqrt(1.0f - z * z);
    return v3(math::sintable(p) * r, math::costable(p) * r, z);
}

inline v3 rndDir(const v3& vz, const f32 minRotx, const f32 maxRotx, const f32 minRotz, const f32 maxRotz)
{
    f32 a  = math::randomrange(minRotz, maxRotz) * kPiMul2;
    f32 z  = math::randomrange(minRotx, maxRotx);
    f32 r  = math::sqrt(1.0f - z * z);
    f32	x  = math::sintable(a) * r;
    f32	y  = math::costable(a) * r;
